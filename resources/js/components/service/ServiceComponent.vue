                    ...
                    <div class="card-header">
                        <div class="row">
                            ...
                            <div class="col-sm-7 text-right">
                                 <button class="btn btn-success" @click="openModalS('modal', 'add')">New Item <i class="lni lni-circle-plus"></i></button>
                            </div>
                                ...
                                <tr v-for="item in dataItems" :key="item.id">
                                    ...
                                    <td>
                                          <div class="btn-group">
                                            ...
                                            <button type="button" class="btn btn-warning btn-sm" data-toggle="tooltip" title="Edit Item" v-if="item.deleted_at == null"  @click="openModalS('modal', 'update', item)" >
                                            <i class="lni lni-pencil"></i>
                                            </button>
                                            <button type="button" class="btn btn-primary btn-sm" data-toggle="tooltip" title="Delete Item" @click="DeleteOrRestoreS(item)">
