                        ...
                        <div class="table-responsive">
                            ...
                            <tbody>
                                ...
                                <tr v-for="item in dataItems" :key="item.id">
                                    ...
                                    <td>
                                        <a v-if="item.element =='div-group-img'|| item.element =='div-group-head' || item.element =='div-group'||item.element =='slide'" class="btn btn-info btn-sm" v-bind:href="'/itemDetails/'+item.id"  > </a>
