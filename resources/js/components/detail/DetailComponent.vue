        ...
        <div class="row justify-content-center">
                        ...
                        <div class="form-group row">
                            <div class="col-md-12">
                                <div class="input-group">
                                    <input type="date" v-model="search" @keyup.enter="ListMain(1)" class="form-control">
                                    <button type="submit" @click="ListMain(1)" class="btn btn-primary"><i class="fa fa-search"></i> Buscar</button>
                                </div>
                            </div>
                        </div>
                            ...
                            <tbody>
                                <tr v-if="pagination.total == 0" class="text-center">
                                    <th colspan="5" class="text-center no-data">
                                        <h2><span class="badge  badge-pill badge-info">Details Not Found</span></h2>
                                    </th>
                                </tr>
            ...
            <!-- The Modal -->
                ...
                <div class="modal-dialog">
                    ...
                    <!-- Modal body -->
                    <form id='formItemD' enctype="multipart/form-data" >
                    <div class="modal-body">
                             <div class="form-group">
                                <label for="pwd">Title:</label>
                                  <textarea v-model="Title" placeholder="Enter title item" class="form-control rounded-0" name="name" id="title" rows="3"></textarea>
                            </div>
                             <div class="form-group">
