                ...
                <div class="elementor-tabs">
                  <div class="elementor-tabs-wrapper" role="tablist">
                    ...
                    <div id="elementor-tab-title-1843"
                      class="elementor-tab-title elementor-tab-desktop-title elementor-active" onclick="show_hide(1843)">Perks</div>
                  </div>
                  <div class="elementor-tabs-content-wrapper" role="tablist" aria-orientation="vertical">
                    <div id="elementor-1841" class="elementor-tab-title elementor-tab-mobile-title" onclick="show_hide(1841)">
                      Requirements</div>
                    ...
                    <div id="elementor-1842" class="elementor-tab-title elementor-tab-mobile-title" onclick="show_hide(1842)">Job
                      Description</div>
                    ...
                    <div id="elementor-1843" class="elementor-tab-title elementor-tab-mobile-title elementor-active" onclick="show_hide(1843)">Perks</div>
