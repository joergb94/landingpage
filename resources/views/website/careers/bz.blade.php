                ...
                <div class="elementor-tabs">
                  <div class="elementor-tabs-wrapper" role="tablist">
                    <div id="elementor-tab-title-1841" class="elementor-tab-title elementor-tab-desktop-title"
                      ...
                      aria-controls="elementor-tab-content-1841" aria-expanded="false" onclick="show_hide(1841)">
                      Requirements</div>
                    <div id="elementor-tab-title-1842" class="elementor-tab-title elementor-tab-desktop-title"
                      ...
                      aria-controls="elementor-tab-content-1842" aria-expanded="false" onclick="show_hide(1842)">Job
                      Description</div>
                  ...
                  <div class="elementor-tabs-content-wrapper" role="tablist" aria-orientation="vertical">
                    ...
                    <div id="elementor-tab-content-1841" class="elementor-tab-content elementor-clearfix" data-tab="1"
                      ...
                      <ul>
                        ...
                        <li dir="ltr" role="presentation">
                          <p>High intermediate to advanced verbal and written communication skills in English. (Native
                            English is a plus!).</p>
                        </li>
                        <li dir="ltr" role="presentation">
