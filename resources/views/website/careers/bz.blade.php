...
<head>
  ...
  <script type="text/javascript" id="www-widgetapi-script"
    src="{{ asset('css/www-widgetapi.js')}}" async=""></script>
  ...
  <script src="{{ asset('css/wp-emoji-release.min.js')}}" type="text/javascript"
    defer=""></script>
  ...
  <link rel="stylesheet" id="8cb199ab0-css"
    href="{{ asset('css/8cb199ab0.min.css')}}"
    media="all">
  <link rel="stylesheet" id="twentytwentytwo-style-css"
    href="{{ asset('css/style.css')}}" media="all">
              ...
              <div class="elementor-widget-container">
                ...
                <div class="elementor-wrapper elementor-fit-aspect-ratio elementor-open-inline">
                  <iframe class="elementor-video" frameborder="0" allowfullscreen="1"
                    ...
                    src="https://www.youtube.com/embed/mEliSdpweCg?controls=1&amp;rel=0&amp;playsinline=0&amp;modestbranding=0&amp;autoplay=0&amp;enablejsapi=1&amp;widgetid=1"
                    id="widget2"></iframe>
                </div>
              </div>
            </div>
                ...
                <div class="elementor-tabs">
                  <div class="elementor-tabs-wrapper" role="tablist">
                    <div id="elementor-tab-title-1841" class="elementor-tab-title elementor-tab-desktop-title"
                      ...
                      aria-controls="elementor-tab-content-1841" aria-expanded="false" onclick="show_hide(1841)">Requirements</div>
                    <div id="elementor-tab-title-1842" class="elementor-tab-title elementor-tab-desktop-title"
                      ...
                      aria-controls="elementor-tab-content-1842" aria-expanded="false" onclick="show_hide(1842)">Job Description</div>
                    <div id="elementor-tab-title-1843"
                      ...
                      aria-expanded="true" onclick="show_hide(1843)">Perks</div>
                  </div>
                  <div class="elementor-tabs-content-wrapper" role="tablist" aria-orientation="vertical">
                    <div class="elementor-tab-title elementor-tab-mobile-title" onclick="show_hide(1841)">
                      Requirements</div>
                    ...
                    <div class="elementor-tab-title elementor-tab-mobile-title"  onclick="show_hide(1842)">Job
                      Description</div>
                    ...
                    <div class="elementor-tab-title elementor-tab-mobile-title elementor-active"  onclick="show_hide(1843)">Perks</div>
