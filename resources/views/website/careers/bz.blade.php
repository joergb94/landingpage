...
<body id="app">
  ...
  @include('website.careers.items.navbar')
  @include('website.careers.items.header')
  <br>
          ...
          <div class="elementor-widget-wrap elementor-element-populated">
            <div class="elementor-element elementor-element-12500c60 elementor-widget elementor-widget-text-editor"
              ...
              <div class="elementor-widget-container">
                ...
                <h1><span class="text-dp">Work with different businesses</span> <span class="text-dp-yellow">all across North America!</span></h1>
              </div>
            </div>
    ...
    <section>
      <div class="container">
              ...
              <ul class="nav nav-tabs" role="tablist">
                <li class="nav-item">
                  <a class="nav-link active"  id="nav-link1" onclick="show_hide(1)">Requirements</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link"  id="nav-link2" onclick="show_hide(2)">Job Description</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link"  id="nav-link3" onclick="show_hide(3)">Perks</a>
                </li>
              </ul>

            <!-- Tab panes -->
            <div class="tab-content">
              <div id="div-link1" class="container tab-pane active"><br>
                      <ul>
              ...
              <div id="div-link2" class="container tab-pane" style="display:none"><br>
				  <ul>
                        <li aria-level="1">
                          <p>5 days a week</p>
                        </li>
              ...
              <div id="div-link3" class="container tab-pane" tyle="display:none"><br>
					<ul>
                        <li aria-level="1">
            ...
            <div
              ...
              <div class="elementor-widget-container">
                <div class="elementor-button-wrapper">
                  <a href="https://form.jotform.com/222726791656062"
  ...
  <input id="baseUrl" type="hidden" value="{{ \Request::root() }}">
   ...
   <script src="{{ asset('js/hidShow.js') }}" defer></script>
</body>
