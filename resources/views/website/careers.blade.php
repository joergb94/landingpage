...
<head>
  ...
  <script src="http://elmercadomorado.com/wp-includes/js/wp-emoji-release.min.js?ver=5.9.3" type="text/javascript"
    defer=""></script>
  ...
  <link rel="stylesheet" id="8cb199ab0-css"
    href="https://elmercadomorado.com/wp-content/uploads/essential-addons-elementor/8cb199ab0.min.css?ver=1652891197"
    media="all">
  <link rel="stylesheet" id="twentytwentytwo-style-css"
    href="http://elmercadomorado.com/wp-content/themes/twentytwentytwo/style.css?ver=1.1" media="all">
...
<body
          ...
          <div class="elementor-widget-wrap elementor-element-populated">
            <div class="elementor-element elementor-element-12500c60 elementor-widget elementor-widget-text-editor"
              ...
              <div class="elementor-widget-container">
                ...
                <h1>Work with businesses all over North America!</h1>
              </div>
            </div>
            <div class="elementor-element elementor-element-42619be6 elementor-widget elementor-widget-text-editor"
              ...
              <div class="elementor-widget-container">
                <p>Every day thousands of customers call their business in order many reasons. <strong>As an answering
                    service representative, you will receive these calls by following specific procedures and
                    prompts.</strong></p>
                <p>Hospitals, Real States, Gas monitoring, and Attorneys; are just some of the lines of businesses we’re
                  serving for. Apply now, read the full page to fulfill your expectations about the work, and let us
                  know of any remaining concerns. We will be happy to answer every doubt.</p>
              </div>
            </div>
          </div>
        </div>
                ...
                <div class="elementor-tabs">
                  <div class="elementor-tabs-wrapper" role="tablist">
                    <div id="elementor-tab-title-1841" class="elementor-tab-title elementor-tab-desktop-title"
                      aria-selected="false" data-tab="1" role="tab" tabindex="-1"
                      aria-controls="elementor-tab-content-1841" aria-expanded="false">Requirements</div>
                    <div id="elementor-tab-title-1842" class="elementor-tab-title elementor-tab-desktop-title"
                      ...
                      aria-controls="elementor-tab-content-1842" aria-expanded="false">Job Description</div>
                    <div id="elementor-tab-title-1843"
                      class="elementor-tab-title elementor-tab-desktop-title elementor-active" aria-selected="true"
                      data-tab="3" role="tab" tabindex="0" aria-controls="elementor-tab-content-1843"
                      aria-expanded="true">Perks</div>
                  </div>
                  <div class="elementor-tabs-content-wrapper" role="tablist" aria-orientation="vertical">
                    <div class="elementor-tab-title elementor-tab-mobile-title" aria-selected="false" data-tab="1"
                      role="tab" tabindex="-1" aria-controls="elementor-tab-content-1841" aria-expanded="false">
                      Requirements</div>
                    <div id="elementor-tab-content-1841" class="elementor-tab-content elementor-clearfix" data-tab="1"
                      ...
                      <ul>
                        <li dir="ltr" role="presentation">
                          <p>Excellent speaking and writing English skills, Native speakers is a plus</p>
                        </li>
                        <li dir="ltr" role="presentation">
                          <p>Multitasking skills – Listening, talking, and writing at the same time</p>
                        </li>
                        <li dir="ltr" role="presentation">
                    ...
                    <div class="elementor-tab-title elementor-tab-mobile-title" aria-selected="false" data-tab="2"
                      role="tab" tabindex="-1" aria-controls="elementor-tab-content-1842" aria-expanded="false">Job
                      Description</div>
                    <div id="elementor-tab-content-1842" class="elementor-tab-content elementor-clearfix" data-tab="2"
                      ...
                      <ul>
                        ...
                        <li aria-level="1">
                          <p>Work directly with a client, no sales or campaigns</p>
                        </li>
                      </ul>
                    </div>
                    <div class="elementor-tab-title elementor-tab-mobile-title elementor-active" aria-selected="true"
                      data-tab="3" role="tab" tabindex="0" aria-controls="elementor-tab-content-1843"
                      aria-expanded="true">Perks</div>
                    <div id="elementor-tab-content-1843"
                      ...
                      <ul>
                        <li aria-level="1">
                          <p>$13,000&nbsp; MX a month from answering calls starting</p>
                        </li>
                        <li aria-level="1">
                          <p>Monthly Bonuses</p>
                        </li>
  ...
  <link rel="stylesheet" id="e-animations-css"
    href="http://elmercadomorado.com/wp-content/plugins/elementor/assets/lib/animations/animations.min.css?ver=3.6.5"
    media="all">
